...
public class Constants {
	...
	public static String Expected_ErrorText = "Invalid credentials";
	
			
				//	MyInfoTestCases Page
	
	public static String EnterFirstName = "Vijay";
	public static String EnterMiddleName = "Arun";
	public static String EnterLastName = "Kale";
	public static String EnterNickName = "Vina";
	public static String EnterEmployeeID = "Emp01";   
	public static String EnterOtherID = "OtherID 000222";
	public static String EnterDriverLicenseNumber = "DLN 0000123";
	public static String EnterSSNNumber = "SSN Number 0000123";
	public static String EnterSINNumber = "SIN Number 00001234";
	public static String chooseNationality = "Indian";
